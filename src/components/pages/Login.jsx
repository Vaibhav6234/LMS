...
const Login = () => {
  return (
	<div className='p-4 m-2 flex  justify-center'>
		<div className="m-2 h-auto w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-950 text-gray-50">
	<h1 className="text-2xl font-bold text-center">Login</h1>
	<form noValidate="" action="" className="space-y-6">
		<div className="space-y-1 text-sm">
			<label htmlFor="username" className="block dark:text-gray-100">Username</label>
		...
		<div className="space-y-1 text-sm">
			...
			<div className="flex justify-end text-xs dark:text-gray-100">
				<a rel="noopener noreferrer" href="#">Forgot Password?</a>
			</div>
		</div>
		<button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-violet-600 active:scale-90">Sign in</button>
	</form>
