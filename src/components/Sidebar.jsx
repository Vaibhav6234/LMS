...
const Sidebar = () => {
  return (
    <div className="h-full p-3 space-y-2 w-60 bg-gray-950 text-gray-800">
	<div className="flex items-center p-2 space-x-4">
		...
		<div>
			...
			<span className="flex items-center space-x-1">
				<a rel="noopener noreferrer" href="#" className="text-xs hover:underline text-gray-300">View profile</a>
			</span>
		</div>
	</div>
	<div className="divide-y dark:divide-gray-00">
